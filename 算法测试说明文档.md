...
本人提交参赛文件中单独包括一份 result_processed_scenarios_testing_B1_part.pkl 文件
...
### 容器内预测结果快速验证
本参赛提供结果镜像为 simplewjc/df_eda_image:v3，使用上述镜像启动 Docker容器(合理设置 YOUR_DF_Dataset_PATH,YOUR_PROJECT_PATH)，启动容器命令为:
