...
# 本参赛组提供结果镜像为 simplewjc/df_eda_image:v3 ，使用上述镜像启动 Docker容器(合理设置 YOUR_DF_Dataset_PATH,YOUR_PROJECT_PATH)，启动容器命令为:
# 详情见 算法测试说明文档.md
...
# 本参赛组提供镜像为 simplewjc/df_eda_image:v3，使用上述镜像启动 Docker容器(合理设置 YOUR_DF_Dataset_PATH,YOUR_WOMD_PATH,YOUR_Waymo_Dataset_PATH,YOUR_PROJECT_PATH):
# 详情见 算法测试说明文档.md
