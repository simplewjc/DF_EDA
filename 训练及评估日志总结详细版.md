...
#### checkpoint_epoch_20
```
2025-05-13 22:44:45,510   INFO  *************** Performance of EPOCH /root/workspace/EX_CKPT/eda_b8_e30_t25_notv/ckpt/checkpoint_epoch_20.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
      VEHICLE      0.3745,      0.7776,      1.6013,      0.1718,            
   PEDESTRIAN      0.3544,      0.4007,      0.8275,      0.0901,            
      CYCLIST      0.2851,      0.8023,      1.6779,      0.2391,            
          Avg      0.3380,      0.6602,      1.3689,      0.1670,    
```
#### checkpoint_epoch_24
```
2025-05-13 22:20:40,394   INFO  *************** Performance of EPOCH /root/workspace/EX_CKPT/eda_b8_e30_t25_notv/ckpt/checkpoint_epoch_24.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
      VEHICLE      0.4021,      0.7529,      1.5254,      0.1553,            
   PEDESTRIAN      0.3882,      0.3907,      0.8082,      0.0876,            
      CYCLIST      0.3217,      0.7681,      1.6058,      0.2237,            
          Avg      0.3707,      0.6372,      1.3132,      0.1556,            
```
#### checkpoint_epoch_26
```
...
#### checkpoint_epoch_28.pth
```
2025-04-24 22:21:23,807   INFO  *************** Performance of EPOCH ../output/dfPred/eda_b8_e40_df_t100_fine_tune_25pth/ckpt/checkpoint_epoch_28.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
...
#### checkpoint_epoch_30.pth
```
2025-04-24 20:29:54,190   INFO  *************** Performance of EPOCH ../output/dfPred/eda_b8_e40_df_t100_fine_tune_25pth/ckpt/checkpoint_epoch_30.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
...
#### checkpoint_epoch_33.pth
``` 
2025-04-24 18:31:24,735   INFO  *************** Performance of EPOCH ../output/dfPred/eda_b8_e40_df_t100_fine_tune_25pth/ckpt/checkpoint_epoch_33.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
...
#### checkpoint_epoch_40.pth 
```
2025-04-24 16:08:33,392   INFO  *************** Performance of EPOCH ../output/dfPred/eda_b8_e40_df_t100_fine_tune_25pth/ckpt/checkpoint_epoch_40.pth *****************
       Waymo          mAP       minADE       minFDE     MissRate            
